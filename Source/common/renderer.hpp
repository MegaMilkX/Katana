    ...
    Renderer() {
        {
            ...
            curv[0.0f] = gfxm::vec3(0 / 255.0f, 0 / 255.0f, 0 / 255.0f) * 0.2f; 
            curv[0.5f] = gfxm::vec3(70 / 255.0f, 70 / 255.0f, 70 / 255.0f) * 0.2f;
            curv[0.55f] = gfxm::vec3(140 / 255.0f, 140 / 255.0f, 140 / 255.0f) * 0.2f;
            curv[1.0f] = gfxm::vec3(100 / 255.0f, 100 / 255.0f, 100 / 255.0f) * 0.2f;
            setSkyGradient(curv);
        }
